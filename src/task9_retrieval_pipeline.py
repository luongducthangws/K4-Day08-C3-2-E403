...
def retrieve(
    ...
    # RRF gộp hai thang điểm khác nhau và giữ dense_score để debug/calibrate.
    merged = rerank_rrf(
    ...
    # Fallback quality gate uses the original cosine score, never the small RRF
    # score (~0.016).  PageIndex local mode keeps this path usable without a key.
